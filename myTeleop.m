...
% Last Modified by GUIDE v2.5 30-Dec-2021 09:13:30
...
leftVelocity = 2;        % ���ٶ� (rad/s)
rightVelocity = -2;      % ���ٶ� (rad/s)
forwardVelocity = 2;     % ���ٶ� (m/s)
backwardVelocity = -2;   % ���ٶ� (m/s)
